    ...
    <table>
        ...
        <g:each in="${lookupPersonList}" var="p" >
            <tr>
                ...
                <g:link controller="lookupPerson" action="editLookupPerson" params='[lookupPersonId:"${p.id}"]'><asset:image src="edit-icon.png" width="18" height="18"/></g:link>
                <g:link controller="lookupPerson" action="delete" params='[lookupPersonId:"${p.id}"]' onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');"><g:img dir="images" file="delete-ico.png" width="18" height="18" title="delete file" /></g:link>
                </td>
