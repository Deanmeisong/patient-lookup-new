...
<html>
    ...
    <body>
        ...
        <div id="show-lookupPerson" class="content scaffold-show" role="main">
            ...
            <f:display bean="lookupPerson" />
            <g:form resource="${this.lookupPerson}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.lookupPerson}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
